          ...
          <div className="p-5 border-b border-gray-100">
            <div className="flex gap-3">
              <input
                ...
                className="flex-1 px-4 py-3 border border-gray-200 rounded-2xl focus:outline-none focus:ring-2 focus:ring-blue-500/20 focus:border-blue-500 transition-all bg-gray-50/50"
                disabled={loading}
              />
              <button
                onClick={searchColleges}
                disabled={loading}
                className="px-6 py-3 bg-blue-500 text-white rounded-2xl hover:bg-blue-600 transition-all font-medium shadow-sm hover:shadow-md disabled:opacity-50 disabled:cursor-not-allowed flex items-center gap-2"
              >
                <svg
                  className="w-5 h-5"
                  fill="none"
            ...
            {loading ? (
              ...
              <div className="text-center py-12">
                ...
                <button
                  ...
                  className="px-6 py-2.5 bg-blue-500 text-white rounded-xl hover:bg-blue-600 transition-all shadow-sm hover:shadow-md"
                >
                  Retry
                </button>
              </div>
          ...
          <div className="p-5 border-t border-gray-100 bg-gray-50/30 flex justify-between">
            ...
            {compareIds.length > 0 && (
              <button
                ...
                className="px-6 py-2.5 bg-blue-500 text-white rounded-xl hover:bg-blue-600 font-medium transition-all shadow-sm hover:shadow-md"
                disabled={addingCollegeId || removingCollegeId}
              >
