    ...
    return (
      <>
        <div
          ...
          className="h-full min-h-[420px] bg-gray-100 rounded-2xl overflow-hidden border-2 border-dashed border-gray-300 hover:border-blue-400 group flex flex-col items-center justify-center text-center transition-all duration-300 cursor-pointer hover:shadow-xl"
        >
          <div className="bg-white rounded-full p-6 mb-4 shadow-sm group-hover:scale-110 transition-transform">
            <BadgePlus className="w-14 h-14 text-gray-400 group-hover:text-blue-500 transition-colors" />
          </div>
      ...
      <div className="relative h-52 overflow-hidden bg-gray-200 flex-shrink-0">
        ...
        {college.ranking && (
          <div className="absolute bottom-4 left-4 bg-black/70 backdrop-blur-sm px-3 py-1 rounded-full flex items-center gap-1 text-xs font-semibold text-white">
            <Award className="w-3.5 h-3.5 text-blue-400" />#{college.ranking}{" "}
            Rank
          </div>
        )}
