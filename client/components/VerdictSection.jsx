  ...
  return (
    <div className="space-y-6">
      ...
      {overallBest && overallBestData && overallBestData.count > 0 && (
        <div className="relative bg-gradient-to-br from-blue-50 via-sky-50 to-indigo-50 rounded-2xl overflow-hidden shadow-lg border border-blue-200">
          <div className="absolute top-0 right-0 w-32 h-32 bg-blue-200 rounded-full filter blur-3xl opacity-20"></div>
          <div className="absolute bottom-0 left-0 w-40 h-40 bg-blue-200 rounded-full filter blur-3xl opacity-20"></div>
