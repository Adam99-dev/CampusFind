      ...
      toast.warning(
        <div>
          ...
          <button
            ...
            className="ml-3 text-blue-500 font-semibold hover:underline"
          >
            Login Now
          </button>
        </div>,
    ...
    <div className="bg-white rounded-2xl overflow-hidden shadow-md hover:shadow-xl transition-all duration-300 border border-gray-100 hover:border-blue-200 group">
      ...
      <div className="relative h-48 overflow-hidden">
        ...
        {showCompareButton && isCompared && (
          <div className="absolute bottom-4 right-4 bg-blue-600 backdrop-blur-sm px-2 py-1 rounded-full flex items-center gap-1 shadow-lg animate-pulse">
