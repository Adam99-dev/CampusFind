...
<button
  ...
  className="inline-flex items-center gap-2 rounded-xl border border-blue-200 bg-blue-50 px-4 py-2 text-sm font-semibold text-blue-700 shadow-sm transition-all hover:border-blue-300 hover:bg-blue-100 hover:shadow-md active:scale-95"
>
  {text === "Share" ? <Share size={18} /> : <Check size={18} />}
  {text}
</button>
            </div>
          </div>
            ...
            <div className="relative rounded-3xl overflow-hidden shadow-2xl aspect-video">
              ...
              <div className="absolute bottom-0 left-0 right-0 p-8">
                <div className="flex items-center gap-2 mb-3">
                  {college.ranking && (
                    <span className="bg-blue-400 text-black px-3 py-1 rounded-full text-sm font-semibold flex items-center gap-1">
                  ...
                  {college.courses.map((course, index) => (
                    ...
                    >
                      ...
                      <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-4">
                        ...
                        <button className="mt-4 md:mt-0 px-6 py-2.5 bg-gradient-to-r from-blue-600 to-blue-600 text-white rounded-xl font-medium hover:shadow-lg transition-all duration-300 transform hover:scale-105">
                          Apply Now →
                        </button>
                      </div>
                    </div>
            ...
            {activeTab === "placements" && (
              <div className="bg-white rounded-3xl p-8 shadow-sm border border-gray-100">
                ...
                <div className="grid md:grid-cols-2 gap-6">
                  ...
                  <div className="space-y-4">
                    <div className="p-4 bg-gradient-to-r from-blue-50 to-pink-50 rounded-xl">
          ...
          <div className="space-y-6">
            <div className="bg-white rounded-3xl p-8 shadow-lg border border-gray-100 top-24">
              ...
              <div className="space-y-3">
                <button className="w-full py-4 bg-gradient-to-r from-blue-600 to-blue-700 hover:from-blue-700 hover:to-blue-800 text-white rounded-2xl font-semibold transition-all transform hover:scale-[1.02]">
                  Apply Now
                </button>
                <button className="w-full py-4 border-2 border-gray-300 hover:border-blue-600 hover:bg-blue-50 rounded-2xl font-semibold transition-all flex items-center justify-center gap-2">
                  <Download size={18} />
                  Download Brochure
                </button>
              </div>
