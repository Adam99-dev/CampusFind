      ...
      <div className="min-h-screen bg-gray-50 flex items-center justify-center px-4 py-8">
        <div className="text-center max-w-md w-full">
          ...
          <div className="space-y-3">
            <button
              onClick={handleRetry}
              className="px-8 py-3 bg-blue-500 hover:bg-blue-600 text-white rounded-xl font-medium transition-all shadow-sm hover:shadow-md w-full sm:w-auto"
            >
              Try Again
            </button>
      ...
      <div className="min-h-screen bg-gray-50 py-8 sm:py-12">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="bg-white rounded-3xl p-12 sm:p-16 text-center shadow-sm border border-gray-100">
            ...
            <button
              onClick={() => window.location.href = '/'}
              className="px-8 py-3 bg-blue-500 hover:bg-blue-600 text-white rounded-xl font-medium transition-all shadow-sm hover:shadow-md"
            >
              Explore Colleges
            </button>
          </div>
        ...
        <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center mb-8 gap-4">
          ...
          <div className="flex items-center gap-3">
            ...
            <button
              ...
              className="bg-white px-4 py-2 rounded-xl shadow-sm border border-gray-200 hover:border-blue-200 transition-all disabled:opacity-50"
            >
              {isRefreshing ? (
