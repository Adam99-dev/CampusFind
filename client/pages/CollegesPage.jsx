  ...
  return (
    <div className="min-h-screen bg-gray-50 py-10">
      <div className="max-w-7xl mx-auto px-4">
        ...
        <div className="bg-gradient-to-r from-blue-50 to-blue-50 rounded-2xl shadow-md mb-8 border border-blue-100">
          <div className="p-5">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-5 gap-3">
              ...
              <div className="relative">
                ...
                <input
                  ...
                  className="w-full border border-gray-200 rounded-xl pl-9 pr-4 py-2.5 focus:border-blue-400 focus:ring-2 focus:ring-blue-200 bg-white transition-all text-sm"
                />
              </div>
              ...
              <div className="relative">
                ...
                <input
                  ...
                  className="w-full border border-gray-200 rounded-xl pl-7 pr-4 py-2.5 focus:border-blue-400 focus:ring-2 focus:ring-blue-200 bg-white transition-all text-sm"
                />
              </div>
              ...
              <div className="relative">
                ...
                <select
                  ...
                  className="w-full border border-gray-200 rounded-xl pl-9 pr-8 py-2.5 focus:border-blue-400 focus:ring-2 focus:ring-blue-200 bg-white appearance-none cursor-pointer transition-all text-sm"
                >
              ...
              <div className="flex gap-3">
                <button
                  ...
                  className="flex-1 bg-blue-600 hover:bg-blue-700 text-white rounded-xl py-2.5 font-medium transition-all shadow-sm"
                >
                  Apply Filters
                </button>
          ...
          <>
            ...
            <div className="flex justify-center items-center gap-4 mt-12">
              ...
              <button
                ...
                onClick={() => setPage((p) => p + 1)}
                className="px-6 py-2.5 bg-blue-600 text-white rounded-xl disabled:opacity-50 hover:bg-blue-700 transition"
              >
                Next
              </button>
            </div>
